...
'''  _pyNavigator.py
https://learndataanalysis.org/create-a-python-app-to-navigate-python-modules/
https://youtu.be/5K4P0w6LH4U
...
from PyQt5.QtWidgets import QApplication, QWidget, QLabel, QLineEdit, QTextEdit, \
    QListWidget, QComboBox, QVBoxLayout, QHBoxLayout
